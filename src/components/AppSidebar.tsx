import { LayoutDashboard, Building2, Ambulance, MapPin, LogOut } from "lucide-react";
...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel className="text-sidebar-primary font-bold text-xs uppercase tracking-wider">
            {!collapsed && "MedNav Admin"}
          </SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {navItems.map((item) => (
